...
<?php include"includes/table_settings.php"?>
   ...
   <div class="module_title">Received Items From Main Store</div>
  ...
  <?php do{?>
    ...
    <tr>
      ...
      <td><a href=".?site_approve_item_view= true&amp;site_req_id=<?php echo $row_get_site_req['id']; ?>&site_id=<?php echo $row_get_site_req['site_id']; ?>"><input name="" value="Items" type="submit" id="edit_forms"/></a></td>    
    </tr>
