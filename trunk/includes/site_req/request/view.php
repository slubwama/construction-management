...
<?php include"includes/table_settings.php"?>
   ...
   <div><a href="."><img src="images/back-button.png" width="30" height="30" title="Back" /></a><a href=".?site_req_add&action=Add">
  <img src="images/add-button.jpg" width="30" height="30" title="Add <?php echo $object_name ?>" /></a></div> 
  <div class="module_title">Site Requstion</div>
  ...
  <?php do{
	  $approved_time=$row_get_site_req['approved_date'];
	  ?>
    <!--Loop start, you could use a repeat region here-->
    <tr>
      ...
      <td><?php echo date("d-M-Y",strtotime($row_get_site_req['created_date']))?></td>
      <td><a href=".?<?php get_child_link($approved_time,"site_approve_item_view","site_req_item_view");?>= true&amp;site_req_id=<?php echo $row_get_site_req['id']; ?>&back_page=site_req_view"><input name="" value="Items" type="submit" id="edit_forms"/></a></td>
      <td><?php   get_delete_link($approved_time,"site_req",$row_get_site_req['id']);?></td>
    </tr>
