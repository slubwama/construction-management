...
SELECT person.first_name,
  ...
  FROM    (   (   birus.user user
	   ...
	   WHERE site_req.hoc_approved_date='0000-00-00 00:00:00' AND site_req.approved_date !='0000-00-00 00:00:00'
";
...
<?php
if(isset($_REQUEST['site_req_hoc_approve']) && $_REQUEST['site_req_hoc_approve']==true){
	$approve_update="UPDATE birus.site_req SET hoc_approved_date = '".date("y-m-d")."', hoc_approved_by = '".$loggedin_id."', hoc_approved='approved' WHERE site_req.id ='".$_REQUEST['id']."';";
	mysql_query($approve_update, $birus_conn) or die(mysql_error());
	if(mysql_affected_rows($birus_conn)>0){
			redirect_birus("site_req_hoc_approve_view","2");
		}
	}
 ?>
...
<div><a href="."><img src="images/back-button.png" width="30" height="30" title="Back" /></a></div> 
   <div class="module_title">Approve Requsition</div>
  ...
  <?php do{?>
    ...
    <tr>
      ...
      <td><a href=".?site_approve_item_view= true&amp;site_req_id=<?php echo $row_get_site_req['id']; ?>&back_page=site_req_hoc_approve_view"><input name="" value="Items" type="submit" id="edit_forms"/></a></td>
      <td><a href=".?site_req_hoc_approve_view&site_req_hoc_approve=true&id=<?php echo $row_get_site_req['id']; ?>"><input name="" value="Approve Requsition" type="submit" id="edit_forms"/></a></td>
    </tr>
