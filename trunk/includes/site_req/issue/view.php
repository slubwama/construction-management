...
<?php include"includes/table_settings.php"?>
   ...
   <div class="module_title">Issue Items From Main Store</div>
  ...
  <?php do{?>
    ...
    <tr>
      ...
      <td><a href=".?site_issue_item_view= true&amp;site_req_id=<?php echo $row_get_site_req['id']; ?>"><input name="" value="Items" type="submit" id="edit_forms"/></a></td>    
      <td><a href=".?site_req_issue_view&amp;site_req_issue=true&amp;site_req_issued&id=<?php echo $row_get_site_req['id']; ?>"><input name="" value="Issue Requesition" type="submit" id="edit_forms" style="width:100px;"/></a></td>
    </tr>
