...
<div><a href=".?site_req_view"><img src="images/back-button.png" width="30" height="30" title="Back" /></a></div>
  ...
  <?php do{?>
    ...
    <tr>
      ...
      <td>
      <?php 
if($row_get_site_req_item['qty_issued']==""){
echo "<a href='.?site_req_item_id=".$row_get_site_req_item['id']."&amp;site_req_item_issue= true&amp;site_req_id=".$_REQUEST['site_req_id'].";&site_id=".$_REQUEST['site_id']."&action=Issue'><input name='' value='Issue' type='submit' id='edit_forms'/></a>";
}
else{
	echo"Issued";
	}
