<?php get_main_menu("sitesupervisor")?>
   <div style="width:90%; margin-left:auto; margin-right:auto;">
    <div class="form_title">
            ...
            <?php echo $_REQUEST["action"];?> Site Receive <?php echo $row_get_branch_by_id['name']?>
    </div>
    <div class="box">
<?php
...
<form action="<?php echo $editFormAction; ?>" method="post" name="site_req_form" id="site_req_form">
  <table width="404" align="left">
    <tr valign="baseline">
      ...
      <td width="274">
      <input type="hidden" name="req_no" value="<?php echo $row_site_req_last_insert['id']; ?>" size="32" />
      <?php echo "SReq".(1+$row_site_req_last_insert['id']); ?></td>
    </tr>
    
     <tr valign="baseline">
      <td width="51" align="left" nowrap="nowrap">Delivery Note No.:</td>
      <td width="274">
      <input type="text" name="delivery_note_no" value="" size="32" /></td>
    </tr>
   
     <tr valign="baseline">
      <td width="51" align="left" nowrap="nowrap">Delivery Note Attachment:</td>
      <td width="274">
      <input type="file" name="delivery_note_url" value="" size="32" /></td>
    </tr>
    <tr valign="baseline">
